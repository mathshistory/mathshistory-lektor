...
class ChooserWidget extends React.Component {
    ...
    return (
      <div className='btn-group action-bar'>
        ...
        <button
          ...
          disabled={this.keyFieldValue() && ((typeof this.keyFieldValue() === 'string' && this.keyFieldValue().trim() === '') || this.keyFieldIsDuplicate())}
  ...
  render () {
    ...
    if (keyFieldVal && typeof keyFieldVal === 'string' && keyFieldVal.trim() === '') {
